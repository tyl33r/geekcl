...
{{< hackcss-form name="validate" action="/validate" >}}
  {{< hackcss-formgroup name="integrity" >}}
    ...
    >}}
    {{< hackcss-helpblock >}}
      Submit with 10.3.2 <a href="/feature/release-hashes">Release Hash</a> to validate.
...
<script>
  (function (window, document, undefined) {
    "use strict";
    const digest = 'xK71MBZBIyTPwKFZuXcZ6VGJw3lJeuwjfrW1NiTKSuXyRpAlK3smg1RhOxDc3QdGz7Zgmu0FX3dL2RIGYeO7Lg==';
    const confirm = form => {
